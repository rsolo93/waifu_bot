...
export declare type TextChannelType = ChannelType.DM | ChannelType.GroupDM | ChannelType.GuildNews | ChannelType.GuildPublicThread | ChannelType.GuildPrivateThread | ChannelType.GuildNewsThread | ChannelType.GuildText | ChannelType.GuildForum;
export declare type GuildChannelType = Exclude<TextChannelType | ChannelType.GuildVoice | ChannelType.GuildStageVoice | ChannelType.GuildNews, ChannelType.DM | ChannelType.GroupDM>;
...
export interface APIThreadChannel extends APIGuildChannel<ChannelType.GuildPublicThread | ChannelType.GuildPrivateThread | ChannelType.GuildNewsThread> {
    /**
...
export declare type APIGuildForumChannel = APIGuildTextChannel<ChannelType.GuildForum>;
/**
 * https://discord.com/developers/docs/resources/channel#channel-object-channel-structure
 */
export declare type APIChannel = APIGroupDMChannel | APIDMChannel | APITextChannel | APINewsChannel | APIVoiceChannel | APIGuildCategoryChannel | APIThreadChannel | APINewsChannel | APIGuildForumChannel;
/**
